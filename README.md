...
## 8. Recommendation
**H1** OTA Dependency & Net Revenue Leakage — สมมติฐานได้รับการสนับสนุน
จากกราฟทั้งหมดจะสรุปได้ว่า : ลูกค้ามีการจองโรแรมผ่านช่องทาง Expedia และ Booking.com สูงมาก นับเป็น 51.06% ของการจองทั้งปี ทำให้รายได้ที่เข้ามาส่วนนึงถูกหักค่า Commision ไปพอสมควร ส่งผลให้ Commission Loss สะสมตลอดปี (คำนวณจาก Commission × LOS) อยู่ที่ 8,867,711.52 บาท 
จึงทำให้เราแนะนำว่า 
1 : ทางโรงแรมควรพัฒนาการทำการตลาดเพื่อเพิ่มยอดจองโรงแรมผ่านช่องทาง Walk-in และ Direct Website มากขึ้น
2 : เพิ่มสิทธิพิเศษ(AAA Discount)ให้กับคนที่ Walk-in & Direct website เพื่อเพิ่มความน่าจองของสองช่องทางนี้
3 : ทางโรงแรมอาจจะพิจารณาในการเจรจาปรับลด % ของค่า commision ลง

<img width="681" height="357" alt="image" src="https://github.com/user-attachments/assets/c883f901-089a-4da2-8851-dc5974865e17" />


**H3**  Rate Code Dilution in Peak Demand — สมมติฐานได้รับการสนับสนุน
จากกราฟทั้งหมดจะสรุปได้ว่า : โรงแรมขาย Non-Refundable และ Promo ในช่วง High Season มากเกินไป ทั้งที่ช่วงนั้นคนอยากจองอยู่แล้ว ไม่จำเป็นต้องลดราคาให้ เงินที่หายไปจาก Non-Refundable เพียงอย่างเดียวสูงถึง 2.2 ล้านบาท เมื่อรวมจากช่องทางอื่นๆแล้วเลยรวมค่าเสียหายกันไปถึง 4.2 ล้านบาท
จึงทำให้เราแนะนำว่า 
1 : จำกัดการใช้ Promotion ต่างๆในช่วง High Season โดยเฉพาะการจำกัดโควต้าการใช้สิทธ์ Non-Refundable แล้วนำโควต้าที่เหลือให้นำไปลงที่ Low Season แทน
2 : อาจให้มีการพิจารณาปรับลด % ในการลดราคาห้องลงตามความเหมาะสมของรายได้ โดยเฉพาะ Non-Refundable และ AAA members

<img width="624" height="375" alt="image" src="https://github.com/user-attachments/assets/63fa8ccf-a8c3-4362-9b8d-3399379b9530" />


**H4** The "Serial Canceller" Impact on Phantom Inventory — สมมติฐานได้รับการสนับสนุน
สรุป : โรงแรมสูญเงินไป 22.9 ล้านบาท ต่อปีเพราะลูกค้าจองแล้วยกเลิกหรือหายหน้าไปเฉยๆ รวมกัน 1,963 ครั้ง
สิ่งที่น่าสังเกตคือ ใครจองล่วงหน้านานยิ่ง Cancel เยอะ กลุ่มที่จองล่วงหน้า 31–60 วัน Cancel สูงถึง 17% ในขณะที่กลุ่มจองกระชั้นชิดภายใน 7 วัน Cancel แค่ 4% แต่กลับ No-Show สูงสุดแทน
วิธีแก้ : ถ้าจองล่วงหน้านาน ควรเก็บเงินมัดจำไว้ก่อน หรือขายเป็น Non-Refundable เลย ส่วนกลุ่มจองกระชั้นชิดควรโทรหรือส่ง SMS ยืนยันก่อน Check-in 1 วัน และถ้าเป็นช่วง High Season ควรจองเกินไว้นิดหน่อย 

<img width="1625" height="177" alt="image" src="https://github.com/user-attachments/assets/0deeba83-f30b-4bc1-8dd3-65bc06c767d9" />


**H5** Short LOS & Orphan Nights — สมมติฐานได้รับการยืนยันบางส่วน
จากกราฟทั้งหมดจะสรุปได้ว่า : สมมุติฐานของเราไม่เป็นจริง ลูกค้ากลุ่ม Lesuire ไม่มีใครที่ทำให้เกิดคืนฟันหลอเลยแต่กลับเป็นกลุ่ม Business และ Transient ที่มีการจองแบบคืนฟันหลอ ทำให้เกิดคืนที่ว่างในวันหยุดทำให้เราเสียโอกาสในการขายให้กับคนที่จะมาจองหลายคืนในช่วงสุดสัปดาห์
จึงทำให้เราแนะนำว่า 
1 : พิจารณาการเพิ่มส่วนลดสำหรับคืนที่สองในช่องทาง walk-in เพราะ Transient ส่วนใหญ่ จะมีแนวโน้ม walk-in สูง ทำให้มีโอกาสขายห้องในคืนฟันหลอได้

<img width="607" height="309" alt="image" src="https://github.com/user-attachments/assets/f20bb390-c740-4947-9f9c-e4134a7e1464" />


## 9. ข้อเสนอแนะเชิงนโยบาย (Policy Recommendations)
...
## 10. โครงสร้างไฟล์โปรเจค (Project Structure)
...
## 12. คำสั่ง (Prompt) ที่ใช้สำหรับในการสร้างข้อมูล
