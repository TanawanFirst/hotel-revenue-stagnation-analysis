...
- ปัญหาการกระจายราคาในแต่ละฤดูการ
- ปัญหาการลดราคาพร่ำเพรื่อ (Rate Code Dilution in Peak Demand) โรงแรมสูญเสียโอกาสในการทำรายได้จากการอนุญาตให้ลูกค้าใช้ Rate Code ที่มีส่วนลด (เช่น AAA Discount, Seasonal Promo) จำนวนมากในช่วง High Season แทนที่จะบังคับขายในราคาปกติ (Rack Rate)
...
- ปัญหาระยะเวลาเข้าพักสั้นสร้าง "คืนฟันหลอ" (Short LOS & Orphan Nights) สมมติฐาน: ลูกค้ากลุ่ม Leisure มีระยะเวลาเข้าพัก (Length of Stay - LOS) เฉลี่ยเพียง 1 คืนในช่วงสุดสัปดาห์ ทำให้เกิด "คืนฟันหลอ" (เช่น วันศุกร์หรือวันอาทิตย์ห้องว่าง) ซึ่งกดดันให้อัตราการเข้าพักรวมและ RevPAR ไม่สามารถโตไปถึงจุดสูงสุดได้
